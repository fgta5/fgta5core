...
export function headerListCriteria(self, db, searchMap, criteria, sort, columns) {
	searchMap.programgroup_isparent = 'programgroup_isparent = ${programgroup_isparent}'
	searchMap.exclude_self = 'programgroup_id<>${exclude_self}'

	sort.programgroup_path = 'asc'
}
