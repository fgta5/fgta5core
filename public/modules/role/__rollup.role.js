 ...
 *
 * This module is generated by fgta5 generator at 11 Oct 2025 04:21
 ************************************************************************/
...
const filepath = join('public/modules/role', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/role/role-${previousVersionNumber}.min.mjs`
...
export default {
	...
	output: {
		file: `public/modules/role/role-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
