...
import * as rolelevelHeaderList from './rolelevelHeaderList.mjs' 
import * as rolelevelHeaderEdit from './rolelevelHeaderEdit.mjs' 
import * as Extender from './rolelevel-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				rolelevelHeaderList.init(self, args), 
				rolelevelHeaderEdit.init(self, args), 
			...
			const modNameList = ['rolelevelHeaderEdit']
...
async function render(self) {
	try {
		...
		// rolelevel-ext.mjs, export function extendPage(self) {} 
