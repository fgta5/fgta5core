 ...
 *
 * usage:
 * npx rollup -c ./public/modules/rolelevel/__rollup.rolelevel.js
 *
 * This module is generated by fgta5 generator at 17 Dec 2025 09:08
 ************************************************************************/
...
const banner = `rolelevel
*
* build at ${currentdate}
`

const filename = `version.txt`;
const filepath = join('public/modules/rolelevel', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/rolelevel/rolelevel-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/rolelevel/rolelevel.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/rolelevel/rolelevel-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
