...
const TitleWhenNew = 'New Applikasi'
const TitleWhenView = 'View Applikasi'
const TitleWhenEdit = 'Edit Applikasi'
...
export async function init(self, args) {
	...
	// export async function appsHeaderEdit_init(self, CurrentState)
	const fn_init_name = 'appsHeaderEdit_init'
...
export async function openSelectedData(self, params) {
	...
	try {
		...
		// export async function appsHeaderEdit_isEditDisabled(self, data)
		...
		// export async function appsHeaderEdit_formOpened(self, frm, CurrentState)
...
async function  frm_locked(self, evt) {
	...
	// export function appsHeaderEdit_formLocked(self, frm, CurrentState) {}
	const fn_name = 'appsHeaderEdit_formLocked'
...
async function  frm_unlocked(self, evt) {
	...
	// export function appsHeaderEdit_formUnlocked(self, frm, CurrentState) {}
	const fn_name = 'appsHeaderEdit_formUnlocked'
	const fn = Extender[fn_name]
	if (typeof fn === 'function') {
		fn(self, frm, CurrentState)
	}
...
async function btn_new_click(self, evt) {
	...
	try {
		...
		if (typeof fn_newdata === 'function') {
			// export async function appsHeaderEdit_newData(self, datainit, frm) {}
...
async function btn_save_click(self, evt) {
	...
	// Extender Autofill
	const fn_autofill_name = 'appsHeaderEdit_autofill'
	...
	// Extender Saving
	// export async function appsHeaderEdit_dataSaving(self, dataToSave, frm, args) {}
	...
	try {
		...
		if (typeof fn_datasaved === 'function') {
			// export async function appsHeaderEdit_dataSaved(self, data, frm) {}
...
async function btn_about_click(self, evt) {
	...
	pageHelper.openSection(self, 'fAbout-section', params, async ()=>{
		...
		AboutSection.Title = 'About Applikasi'
		...
		if ( document.getElementById('fAbout-section-fdescr') == null) {
			...
			divDescr.innerHTML = 'daftar applikasi'
		...
		if ( document.getElementById('fAbout-section-footer') == null) {
			...
			divFooter.innerHTML = 'This module is generated by fgta5 generator at 23 Dec 2025 10:34'
