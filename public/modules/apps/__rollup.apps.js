...
// untuk eksekusi npx
// npx rollup -c ./public/modules/apps/__rollup-apps.js

export default {
	input: "public/modules/apps/apps.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/apps/apps.min.mjs`, // Lokasi output file hasil bundle
