 ...
 *
 * This module is generated by fgta5 generator at 15 Dec 2025 09:06
 ************************************************************************/
...
const filepath = join('public/modules/apps', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/apps/apps-${previousVersionNumber}.min.mjs`
...
export default {
	...
	output: {
		file: `public/modules/apps/apps-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
