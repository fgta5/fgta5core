...
-- =============================================
-- ADD _createby
alter table core."apps" add _createby integer not null ;
...
-- =============================================
-- ADD _createdate
alter table core."apps" add _createdate timestamp with time zone not null default now();
...
-- =============================================
-- ADD _modifyby
alter table core."apps" add _modifyby integer  ;
