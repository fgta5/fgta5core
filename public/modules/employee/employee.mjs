...
import * as employeeHeaderList from './employeeHeaderList.mjs' 
import * as employeeHeaderEdit from './employeeHeaderEdit.mjs' 
...
export default class extends Module {
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				employeeHeaderList.init(self, args), 
				employeeHeaderEdit.init(self, args), 
...
async function render(self) {
	try {
		...
		// employee-ext.mjs, export function extendPage(self) {} 
