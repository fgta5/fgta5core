 ...
 *
 * usage:
 * npx rollup -c ./public/modules/approvalsigntype/__rollup.approvalsigntype.js
 *
 * This module is generated by fgta5 generator at 9 Dec 2025 09:56
 ************************************************************************/
...
const banner = `approvalsigntype
*
* build at ${currentdate}
`

const filename = `version.txt`;
const filepath = join('public/modules/approvalsigntype', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/approvalsigntype/approvalsigntype-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/approvalsigntype/approvalsigntype.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/approvalsigntype/approvalsigntype-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
