...
import * as approvalsigntypeHeaderList from './approvalsigntypeHeaderList.mjs' 
import * as approvalsigntypeHeaderEdit from './approvalsigntypeHeaderEdit.mjs' 
import * as Extender from './approvalsigntype-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		self.Modules = { 
			approvalsigntypeHeaderList, 
			approvalsigntypeHeaderEdit, 
		}
		...
		try {
			...
			await Promise.all([ 
				approvalsigntypeHeaderList.init(self, args), 
				approvalsigntypeHeaderEdit.init(self, args), 
			...
			const modNameList = ['approvalsigntypeHeaderEdit']
...
async function render(self) {
	try {
		...
		// approvalsigntype-ext.mjs, export function extendPage(self) {} 
