...
import * as directoryHeaderList from './directoryHeaderList.mjs' 
import * as directoryHeaderEdit from './directoryHeaderEdit.mjs' 
...
export default class extends Module {
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				directoryHeaderList.init(self, args), 
				directoryHeaderEdit.init(self, args), 
...
async function render(self) {
	try {
		...
		// directory-ext.mjs, export function extendPage(self) {} 
