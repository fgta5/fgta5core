...
import * as sequencerHeaderList from './sequencerHeaderList.mjs' 
import * as sequencerHeaderEdit from './sequencerHeaderEdit.mjs' 
...
export default class extends Module {
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				sequencerHeaderList.init(self, args), 
				sequencerHeaderEdit.init(self, args), 
...
async function render(self) {
	try {
		...
		// sequencer-ext.mjs, export function extendPage(self) {} 
