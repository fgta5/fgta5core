 ...
 *
 * This module is generated by fgta5 generator at 11 Oct 2025 04:19
 ************************************************************************/
...
const filepath = join('public/modules/doc', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/doc/doc-${previousVersionNumber}.min.mjs`
...
export default {
	...
	output: {
		file: `public/modules/doc/doc-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
