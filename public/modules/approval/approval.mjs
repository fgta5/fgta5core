...
import * as approvalHeaderList from './approvalHeaderList.mjs' 
import * as approvalHeaderEdit from './approvalHeaderEdit.mjs' 
import * as Extender from './approval-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				approvalHeaderList.init(self, args), 
				approvalHeaderEdit.init(self, args), 
			...
			const modNameList = ['approvalHeaderEdit']
...
async function render(self) {
	try {
		...
		// approval-ext.mjs, export function extendPage(self) {} 
