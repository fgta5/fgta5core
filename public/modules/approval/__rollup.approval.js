 ...
 *
 * usage:
 * npx rollup -c ./public/modules/approval/__rollup.approval.js
 *
 * This module is generated by fgta5 generator at 8 Dec 2025 09:59
 ************************************************************************/
...
const filepath = join('public/modules/approval', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/approval/approval-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/approval/approval.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/approval/approval-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
