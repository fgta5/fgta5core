 ...
 *
 * This module is generated by fgta5 generator at 23 Dec 2025 12:36
 ************************************************************************/
...
const filepath = join('public/modules/setting', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/setting/setting-${previousVersionNumber}.min.mjs`
...
export default {
	...
	output: {
		file: `public/modules/setting/setting-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
