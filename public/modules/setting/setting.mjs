...
import * as settingHeaderList from './settingHeaderList.mjs' 
import * as settingHeaderEdit from './settingHeaderEdit.mjs' 
...
export default class extends Module {
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				settingHeaderList.init(self, args), 
				settingHeaderEdit.init(self, args), 
			...
			const modNameList = ['settingHeaderEdit']
...
async function render(self) {
	try {
		...
		// Setup Icon
		Crsl.setIconUrl('public/modules/setting/setting.svg')
