...
-- =============================================
-- ADD user_id
alter table core."userfavouriteprogram" add user_id bigint  ;
...
-- =============================================
-- ADD _createby
alter table core."userfavouriteprogram" add _createby bigint not null ;
...
-- =============================================
-- ADD _createdate
alter table core."userfavouriteprogram" add _createdate timestamp with time zone not null ;
...
-- =============================================
-- ADD _modifyby
alter table core."userfavouriteprogram" add _modifyby bigint  ;
