...
const TitleWhenNew = 'New Favourite'
const TitleWhenView = 'View Favourite'
const TitleWhenEdit = 'Edit Favourite'
...
export async function openSelectedData(self, params) {
	...
	try {
		...
		// export function userFavouriteEdit_formOpened(self, frm, CurrentState) {}
...
export function headerLocked(self) {
	...
	// export function userFavouriteEdit_formLocked(self, frm, CurrentState) {}
...
export function headerUnlocked(self) {
	...
	// export function userFavouriteEdit_formUnlocked(self, frm, CurrentState) {}
...
async function  frm_unlocked(self, evt) {
	...
	// Extender untuk event Unlocked
	// export function userFavouriteEdit_formUnlocked(self, frm) {}
	const fn_name = 'userFavouriteEdit_formUnlocked'
	const fn = Extender[fn_name]
	if (typeof fn === 'function') {
		fn(self, frm)
...
async function btn_new_click(self, evt) {
	...
	try {
		...
		// export async function userFavouriteEdit_newData(self, datainit, frm, CurrentState) {}
...
async function btn_save_click(self, evt) {
	...
	// Extender Autofill
	// export async function userFavouriteEdit_autofill(self, frm) {}
	...
	// Extender Saving
	// export async function userFavouriteEdit_dataSaving(self, dataToSave, frm, args) {}
	...
	try {
		...
		// Extender Saving
		// export async function userFavouriteEdit_dataSaved(self, data, frm) {}
...
async function btn_recordstatus_click(self, evt) {
	...
	pageHelper.openSection(self, 'fRecord-section', params, async ()=>{
		...
		try {
			...
			// export async function userFavouriteEdit_addRecordInfo(self,  data) {}
