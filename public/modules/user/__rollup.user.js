 ...
 *
 * This module is generated by fgta5 generator at 23 Dec 2025 11:46
 ************************************************************************/
...
const filepath = join('public/modules/user', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/user/user-${previousVersionNumber}.min.mjs`
...
export default {
	...
	output: {
		file: `public/modules/user/user-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
