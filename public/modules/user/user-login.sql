...
-- =============================================
-- ADD user_id
alter table core."userlogin" add user_id bigint  ;
...
-- =============================================
-- ADD _createby
alter table core."userlogin" add _createby bigint not null ;
...
-- =============================================
-- ADD _createdate
alter table core."userlogin" add _createdate timestamp with time zone not null ;
...
-- =============================================
-- ADD _modifyby
alter table core."userlogin" add _modifyby bigint  ;
