...
export async function init(self, args) {
	...
	try {
		...
		const obj_searchtext = document.getElementById('programgroupHeaderList-txt_searchtext')
		const btn_load = document.getElementById('programgroupHeaderList-btn_gridload')
...
export function keyboardAction(self, actionName, evt) {
	if (actionName=='up') {
		...
		if (tbl.CurrentRow!=null) {
			programgroupHeaderEdit.Section.show({}, ()=>{
