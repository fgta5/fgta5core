...
import * as interfaceHeaderList from './interfaceHeaderList.mjs' 
import * as interfaceHeaderEdit from './interfaceHeaderEdit.mjs' 
...
export default class extends Module {
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				interfaceHeaderList.init(self, args), 
				interfaceHeaderEdit.init(self, args), 
			...
			const modNameList = ['interfaceHeaderEdit']
...
async function render(self) {
	try {
		...
		// interface-ext.mjs, export function extendPage(self) {} 
