 ...
 *
 * usage:
 * npx rollup -c ./public/modules/interface/__rollup.interface.js
 *
 * This module is generated by fgta5 generator at 5 Nov 2025 15:12
 ************************************************************************/
...
const banner = `interface
*
* build at ${currentdate}
`

const filename = `version.txt`;
const filepath = join('public/modules/interface', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/interface/interface-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/interface/interface.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/interface/interface-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
