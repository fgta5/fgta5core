...
comment on table core."group" is 'daftar group';	
...
-- =============================================
-- FIELD: grouptype_id int
-- =============================================
-- ADD grouptype_id
alter table core."group" add grouptype_id int not null default 0;
comment on column core."group".grouptype_id is '';

-- MODIFY grouptype_id
alter table core."group"
	alter column grouptype_id type int,
	ALTER COLUMN grouptype_id SET DEFAULT 0,
	ALTER COLUMN grouptype_id SET NOT NULL;
comment on column core."group".grouptype_id is '';
...
ALTER TABLE core."group" DROP CONSTRAINT fk$core$group$grouptype_id;


-- Add Foreign Key Constraint  
ALTER TABLE core."group"
	ADD CONSTRAINT fk$core$group$grouptype_id
	FOREIGN KEY (grouptype_id)
	REFERENCES core."grouptype"(grouptype_id);
