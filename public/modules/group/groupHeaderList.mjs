...
const tbl =  new $fgta5.Gridview('groupHeaderList-tbl')
const pnl_search = document.getElementById('groupHeaderList-pnl_search')
const btn_gridload = new $fgta5.ActionButton('groupHeaderList-btn_gridload') 

export const Section = CurrentSection
export const SearchParams = {}

export async function init(self, args) {
	console.log('initializing groupHeaderList ...')
	...
	try {
		...
		const obj_searchtext = document.getElementById('groupHeaderList-txt_searchtext')
		const btn_load = document.getElementById('groupHeaderList-btn_gridload')
