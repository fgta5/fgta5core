...
import * as genderHeaderList from './genderHeaderList.mjs' 
import * as genderHeaderEdit from './genderHeaderEdit.mjs' 
import * as Extender from './gender-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				genderHeaderList.init(self, args), 
				genderHeaderEdit.init(self, args), 
			...
			const modNameList = ['genderHeaderEdit']
...
async function render(self) {
	try {
		...
		// gender-ext.mjs, export function extendPage(self) {} 
