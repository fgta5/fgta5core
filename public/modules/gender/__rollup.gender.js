 ...
 *
 * usage:
 * npx rollup -c ./public/modules/gender/__rollup.gender.js
 *
 * This module is generated by fgta5 generator at 9 Dec 2025 13:59
 ************************************************************************/
...
const filepath = join('public/modules/gender', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/gender/gender-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/gender/gender.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/gender/gender-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
