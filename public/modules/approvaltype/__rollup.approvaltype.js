 ...
 *
 * usage:
 * npx rollup -c ./public/modules/approvaltype/__rollup.approvaltype.js
 *
 * This module is generated by fgta5 generator at 9 Dec 2025 10:41
 ************************************************************************/
...
const banner = `approvaltype
*
* build at ${currentdate}
`

const filename = `version.txt`;
const filepath = join('public/modules/approvaltype', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/approvaltype/approvaltype-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/approvaltype/approvaltype.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/approvaltype/approvaltype-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
