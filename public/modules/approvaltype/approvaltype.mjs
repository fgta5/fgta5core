...
import * as approvaltypeHeaderList from './approvaltypeHeaderList.mjs' 
import * as approvaltypeHeaderEdit from './approvaltypeHeaderEdit.mjs' 
import * as approvaltypeRoleList from './approvaltypeRoleList.mjs' 
import * as approvaltypeRoleEdit from './approvaltypeRoleEdit.mjs' 
import * as Extender from './approvaltype-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		self.Modules = { 
			approvaltypeHeaderList, 
			approvaltypeHeaderEdit, 
			approvaltypeRoleList, 
			approvaltypeRoleEdit, 
		}
		...
		try {
			...
			await Promise.all([ 
				approvaltypeHeaderList.init(self, args), 
				approvaltypeHeaderEdit.init(self, args), 
				approvaltypeRoleList.init(self, args), 
				approvaltypeRoleEdit.init(self, args), 
			...
			const modNameList = ['approvaltypeHeaderEdit', 'approvaltypeRoleEdit']
...
async function render(self) {
	try {
		...
		// approvaltype-ext.mjs, export function extendPage(self) {} 
