 ...
 *
 * This module is generated by fgta5 generator at 23 Dec 2025 10:21
 ************************************************************************/
...
const filepath = join('public/modules/program', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/program/program-${previousVersionNumber}.min.mjs`
...
export default {
	...
	output: {
		file: `public/modules/program/program-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
