...
-- =============================================
-- ADD _createby
alter table core."program" add _createby integer not null ;
...
-- =============================================
-- ADD _createdate
alter table core."program" add _createdate timestamp with time zone not null default now();
...
-- =============================================
-- ADD _modifyby
alter table core."program" add _modifyby integer  ;
